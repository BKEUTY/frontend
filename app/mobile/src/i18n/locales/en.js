export default {
    ...
    user_id: "Account ID",
    admin_promotion_id: "Promotion ID",
    ...
    promotion_price: "Special Price",
    no_promos_found: "No promotions found.",
    vip_condition_title: "VIP condition details",
    vip_condition_content: "Membership tier is automatically calculated based on total spending from successfully delivered orders:\n1. Silver: Total spending from 2,000,000 VND\n2. Gold: Total spending from 5,000,000 VND\n3. Platinum: Total spending from 15,000,000 VND\n4. Diamond: Total spending from 30,000,000 VND",
    close_hint: "Close",
    ...
    reviews_high_low: "Review Count: High to low",
    reviews_low_high: "Review Count: Low to high",
    ...
    request_new_return: "New Return Request",
    select_order: "Select Order",
    order_placeholder: "Select order to return",
    return_reason: "Return Reason",
    reason_placeholder: "Select return reason",
    reason_damaged: "Damaged / Broken product",
    reason_wrong: "Wrong product delivered",
    reason_quality: "Quality not as described",
    reason_others: "Other reasons",
    return_description: "Detailed Description",
    desc_placeholder: "Describe the product condition...",
    upload_evidence: "Upload Evidence (Images)",
    drag_upload_hint: "Click or drag images here to upload",
    upload_limit_hint: "Max 5 images. Supports JPG, PNG.",
    no_return_requests: "You have no return requests.",
    ...
    rejected: "Rejected",
    history: "History",
    shipping_timeline: "Order Timeline",
