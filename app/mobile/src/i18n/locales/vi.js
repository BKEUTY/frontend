export default {
    ...
    brand_tagline: "BKEUTY - Đánh thức vẻ đẹp tiềm ẩn",
    mid_autumn_promo: "TRUNG THU RINH QUÀ",
    promo_subtitle: "Ưu đãi lên đến 50% cho tất cả dòng sản phẩm cao cấp",
    brand_story: "Câu chuyện thương hiệu",
    brand_desc: "BKEUTY tự hào là người bạn đồng hành tin cậy trên hành trình chăm sóc sắc đẹp của phụ nữ Việt. Chúng tôi mang đến những sản phẩm chất lượng cao, an toàn và hiệu quả, giúp bạn tự tin tỏa sáng mỗi ngày.",
    ...
    request_return: "Gửi yêu cầu đổi trả",
    returns_desc: "Quản lý các yêu cầu đổi trả và hoàn tiền của bạn",
    request_new_return: "Yêu cầu đổi trả mới",
    ...
    upload_evidence: "Tải lên bằng chứng (hình ảnh)",
    ...
    grand_total: "Tổng tiền thanh toán",
