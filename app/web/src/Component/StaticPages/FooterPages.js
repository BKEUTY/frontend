...
export const RetailSystem = () => {
    ...
    const branches = useMemo(() => [
        ...
        { id: 9, name: "BKEUTY - Đồng Nai", address: "Ấp Đất Mới, xã Long Phước, Đồng Nai", phone: "0908 741 633", status: "Closed", open_date: "2024-05-10", manager: "Nguyễn Văn I" }, // Moved to Page 1
        ...
        { id: 12, name: "BKEUTY - Hà Nội 2", address: "789 Phố Huế, Hai Bà Trưng, Hà Nội", phone: "0908 741 636", status: "Closed", open_date: "2024-07-01", manager: "Hoàng Thị M" }, // Moved to Page 1
    ...
    return (
        <StaticPageLayout title={t('retail_system') || "Hệ Thống Cửa Hàng"}>
            <div className="retail-filters">
                ...
                >
                    <option value="all">{t('retail_filter_status')}: {t('all')}</option>
                    <option value="Open">{t('retail_status_open')}</option>
                    <option value="Closed">{t('retail_status_closed')}</option>
                </select>
            </div>
                    ...
                    <div className="retail-grid">
                        {paginatedBranches.map(branch => (
                            <div key={branch.id} className="store-card">
                                ...
                                <button className="btn-store-detail" onClick={() => setSelectedBranch(branch)}>
                                    {t('retail_detail')}
                                </button>
                            </div>
                        ))}
