export default {
    ...
    admin_product_name: "Tên sản phẩm",
    admin_product_category: "Danh mục",
    admin_product_action: "Hành động",
    ...
    admin_btn_gen_variants: "Tạo tất cả biến thể",
    admin_alert_options: "Thêm tùy chọn sản phẩm",
    admin_alert_options_desc: "Định nghĩa các tùy chọn như Màu sắc hoặc Kích thước để tự động tạo ra các biến thể.",
    admin_alert_variants: "Giá & Tồn kho biến thể",
    admin_alert_variants_desc: "Cấu hình giá và số lượng tồn kho riêng biệt cho mỗi biến thể sản phẩm.",
    admin_btn_finish_later: "Hoàn tất sau",
