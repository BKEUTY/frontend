...
export const vi = {
    ...
    admin_btn_create_continue: "Tạo & Tiếp tục",

    admin_alert_options: "Tùy chọn bắt buộc",
    admin_alert_options_desc: "Bạn phải định nghĩa các tùy chọn (ví dụ: Kích thước, Màu sắc) để tạo biến thể sản phẩm.",
    admin_label_option_name: "Tên tùy chọn (VD: Màu sắc)",
    admin_label_option_values: "Nhập giá trị và nhấn Enter (VD: Đỏ, Xanh)",
    admin_btn_add_option: "Thêm tùy chọn khác",
    admin_btn_gen_variants: "Tạo biến thể & Tiếp tục",

    admin_alert_variants: "Cấu hình biến thể",
    admin_alert_variants_desc: "Thiết lập giá, kho và hình ảnh cho từng biến thể.",
    admin_label_variant: "Biến thể",
    admin_label_price: "Giá (VND)",
    admin_label_stock: "Kho",
    admin_btn_finish_later: "Hoàn tất sau",
    admin_btn_save_finish: "Lưu tất cả & Hoàn tất",
    ...
    admin_placeholder_product_name: "VD: Kem dưỡng ẩm BKEUTY",
    admin_placeholder_desc: "Nhập mô tả sản phẩm...",
    admin_placeholder_categories: "Chọn danh mục",
    admin_btn_upload: "Tải lên",
    admin_msg_create_success: "Tạo sản phẩm thành công!",
    admin_msg_options_success: "Tạo tùy chọn thành công!",
    admin_msg_variants_success: "Cập nhật tất cả biến thể thành công!",
    admin_error_create: "Lỗi khi tạo sản phẩm",
    admin_error_upload_img: "Đã tạo sản phẩm nhưng tải ảnh thất bại.",
    admin_error_options_save: "Lỗi khi lưu tùy chọn.",
