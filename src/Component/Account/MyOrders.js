    ...
    useEffect(() => {
        ...
        fetch(`${process.env.REACT_APP_API_URL}/order/1`) // userId fixed as 1
            ...
            .catch(err => {
                ...
                setOrders([
                    { id: 1001, date: '2025-10-20', total: '500.000đ', status: 'completed' },
                    { id: 1002, date: '2025-10-25', total: '1.200.000đ', status: 'pending' },
                    { id: 1003, date: '2025-11-02', total: '350.000đ', status: 'cancelled' },
                ]);
                setLoading(false);
            });
    }, []);
